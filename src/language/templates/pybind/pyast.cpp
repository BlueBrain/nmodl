...
void init_ast_module(py::module& m) {
    ...
    ast_.def(py::init<>())
            ...
            .def("get_symbol_table", &Ast::get_symbol_table, py::return_value_policy::reference, docstring::get_symbol_table_method)
            .def("get_statement_block", &Ast::get_statement_block, docstring::get_statement_block_method)
