 ...
 */
class CodegenAccVisitor: public CodegenCorenrnCppVisitor {
  protected:
  ...
  public:
    CodegenAccVisitor(const std::string& mod_file,
        ...
        : CodegenCorenrnCppVisitor(mod_file, output_dir, float_type, optimize_ionvar_copies) {}

    CodegenAccVisitor(const std::string& mod_file,
                      std::ostream& stream,
                      const std::string& float_type,
                      bool optimize_ionvar_copies)
        : CodegenCorenrnCppVisitor(mod_file, stream, float_type, optimize_ionvar_copies) {}
};
