...
void CodegenCVisitor::visit_eigen_newton_solver_block(const ast::EigenNewtonSolverBlock& node) {
    ...
    printer->fmt_line(
        "functor(NrnThread* nt, {}* inst, int id, int pnodecount, double v, Datum* indexes, double* data, ThreadDatum* thread) : "
    ...
    printer->add_line("functor newton_functor(nt, inst, id, pnodecount, v, indexes, data, thread);");
