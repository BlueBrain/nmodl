...
void CodegenCorenrnCppVisitor::print_standard_includes() {
    printer->add_newline();
...
void CodegenCorenrnCppVisitor::print_simulator_includes() {
    printer->add_newline();
    printer->add_multi_line(R"CODE(
...
std::string CodegenCorenrnCppVisitor::float_variable_name(const SymbolType& symbol,
...
std::string CodegenCorenrnCppVisitor::int_variable_name(const IndexVariableInfo& symbol,
...
std::string CodegenCorenrnCppVisitor::global_variable_name(const SymbolType& symbol,
                                                    bool use_instance) const {
    if (use_instance) {
...
std::string CodegenCorenrnCppVisitor::get_variable_name(const std::string& name, bool use_instance) const {
...
std::string CodegenCorenrnCppVisitor::conc_write_statement(const std::string& ion_name,
...
std::string CodegenCorenrnCppVisitor::internal_method_arguments() {
 ...
 */
CodegenCorenrnCppVisitor::ParamVector CodegenCorenrnCppVisitor::internal_method_parameters() {
    ParamVector params;
...
const char* CodegenCorenrnCppVisitor::external_method_arguments() noexcept {
    return "id, pnodecount, data, indexes, thread, nt, ml, v";
}


std::string CodegenCorenrnCppVisitor::register_mechanism_arguments() const {
...
const char* CodegenCorenrnCppVisitor::external_method_parameters(bool table) noexcept {
    if (table) {
...
std::string CodegenCorenrnCppVisitor::nrn_thread_arguments() const {
    if (ion_variable_struct_required()) {
 ...
 */
std::string CodegenCorenrnCppVisitor::nrn_thread_internal_arguments() {
    if (ion_variable_struct_required()) {
        return "id, pnodecount, inst, ionvar, data, indexes, thread, nt, v";
    }
    return "id, pnodecount, inst, data, indexes, thread, nt, v";
...
std::string CodegenCorenrnCppVisitor::compute_method_name(BlockType type) const {
...
std::string CodegenCorenrnCppVisitor::global_var_struct_type_qualifier() {
    return "";
}


void CodegenCorenrnCppVisitor::print_global_var_struct_decl() {
    printer->add_line(global_struct(), ' ', global_struct_instance(), ';');
}


void CodegenCorenrnCppVisitor::print_global_var_struct_assertions() const {
...
void CodegenCorenrnCppVisitor::print_backend_namespace_start() {
    // no separate namespace for C++ (cpu) backend
}


void CodegenCorenrnCppVisitor::print_backend_namespace_stop() {
    // no separate namespace for C++ (cpu) backend
}


void CodegenCorenrnCppVisitor::print_memory_allocation_routine() const {
...
void CodegenCorenrnCppVisitor::print_abort_routine() const {
    printer->add_newline(2);
...
bool CodegenCorenrnCppVisitor::nrn_cur_reduction_loop_required() {
...
void CodegenCorenrnCppVisitor::print_thread_getters() {
...
void CodegenCorenrnCppVisitor::print_check_table_thread_function() {
...
void CodegenCorenrnCppVisitor::print_initial_block(const InitialBlock* node) {
...
void CodegenCorenrnCppVisitor::print_net_init() {
...
void CodegenCorenrnCppVisitor::print_net_receive_common_code(const Block& node, bool need_mech_inst) {
    printer->add_multi_line(R"CODE(
        int tid = pnt->_tid;
...
void CodegenCorenrnCppVisitor::print_net_send_buffering_cnt_update() const {
    printer->add_line("i = nsb->_cnt++;");
}

void CodegenCorenrnCppVisitor::print_net_send_buffering_grow() {
    printer->push_block("if (i >= nsb->_size)");
    printer->add_line("nsb->grow();");
    printer->pop_block();
}

void CodegenCorenrnCppVisitor::print_net_send_buffering() {
...
void CodegenCorenrnCppVisitor::print_send_event_move() {
    printer->add_newline();
...
std::string CodegenCorenrnCppVisitor::net_receive_buffering_declaration() {
    return fmt::format("void {}(NrnThread* nt)", method_name("net_buf_receive"));
}


void CodegenCorenrnCppVisitor::print_get_memb_list() {
...
void CodegenCorenrnCppVisitor::print_net_receive_buffering(bool need_mech_inst) {
...
void CodegenCorenrnCppVisitor::print_net_receive_loop_begin() {
...
void CodegenCorenrnCppVisitor::print_net_receive_loop_end() {
    printer->pop_block();
}

void CodegenCorenrnCppVisitor::print_net_receive_kernel() {
...
void CodegenCorenrnCppVisitor::print_net_receive() {
    if (!net_receive_required()) {
        return;
    }
    codegen = true;
 ...
 */
void CodegenCorenrnCppVisitor::print_derivimplicit_kernel(const Block& block) {
...
void CodegenCorenrnCppVisitor::print_newtonspace_transfer_to_device() const {
    // nothing to do on cpu
}


void CodegenCorenrnCppVisitor::visit_derivimplicit_callback(const ast::DerivimplicitCallback& node) {
    if (!codegen) {
        return;
    }
    printer->fmt_line("{}_{}({});",
...
void CodegenCorenrnCppVisitor::visit_solution_expression(const SolutionExpression& node) {
...
void CodegenCorenrnCppVisitor::print_nrn_cur_kernel(const BreakpointBlock& node) {
    printer->add_line("int node_id = node_index[id];");
    printer->add_line("double v = voltage[node_id];");
    print_v_unused();
    if (ion_variable_struct_required()) {
...
void CodegenCorenrnCppVisitor::print_nrn_cur_conductance_kernel(const BreakpointBlock& node) {
    const auto& block = node.get_statement_block();
    print_statement_block(*block, false, false);
...
void CodegenCorenrnCppVisitor::print_nrn_cur_non_conductance_kernel() {
...
void CodegenCorenrnCppVisitor::print_nrn_cur_matrix_shadow_update() {
    if (info.point_process) {
...
void CodegenCorenrnCppVisitor::print_nrn_cur_matrix_shadow_reduction() {
    auto rhs_op = operator_for_rhs();
    auto d_op = operator_for_d();
    if (info.point_process) {
        printer->add_line("int node_id = node_index[id];");
...
void CodegenCorenrnCppVisitor::print_fast_imem_calculation() {
...
void CodegenCorenrnCppVisitor::print_mechanism_register() {
    printer->add_newline(2);
 ...
 * and coreneuron.
 */
void CodegenCorenrnCppVisitor::print_watch_activate() {
...
void CodegenCorenrnCppVisitor::print_headers_include() {
    print_standard_includes();
    print_backend_includes();
    print_simulator_includes();
}

void CodegenCorenrnCppVisitor::print_namespace_begin() {
    print_namespace_start();
    print_backend_namespace_start();
}


void CodegenCorenrnCppVisitor::print_namespace_end() {
...
void CodegenCorenrnCppVisitor::print_v_unused() const {
    if (!info.vectorize) {
        return;
    }
    printer->add_multi_line(R"CODE(
...
void CodegenCorenrnCppVisitor::print_g_unused() const {
    printer->add_multi_line(R"CODE(
        #if NRN_PRCELLSTATE
        inst->g_unused[id] = g;
        #endif
...
void CodegenCorenrnCppVisitor::print_compute_functions() {
...
void CodegenCorenrnCppVisitor::print_codegen_routines() {
    codegen = true;
    print_backend_info();
...
void CodegenCorenrnCppVisitor::print_nrn_init(bool skip_init_check) {
    codegen = true;
    printer->add_newline(2);
...
void CodegenCorenrnCppVisitor::print_nrn_state() {
 ...
 */
void CodegenCorenrnCppVisitor::print_watch_check() {
    if (info.watch_statements.empty()) {
        return;
    }
    codegen = true;
...
void CodegenCorenrnCppVisitor::print_table_check_function(const Block& node) {
...
void CodegenCorenrnCppVisitor::print_table_replacement_function(const ast::Block& node) {
    auto name = node.get_node_name();
    auto statement = get_table_statement(node);
    auto table_variables = statement->get_table_vars();
    auto with = statement->get_with()->eval();
...
void CodegenCorenrnCppVisitor::print_function_tables(const ast::FunctionTableBlock& node) {
    auto name = node.get_node_name();
...
void CodegenCorenrnCppVisitor::print_procedure(const ast::ProcedureBlock& node) {
    print_function_procedure_helper(node);
}

void CodegenCorenrnCppVisitor::print_before_after_block(const ast::Block* node, size_t block_id) {
    codegen = true;
...
void CodegenCorenrnCppVisitor::print_mechanism_range_var_structure(bool print_initializers) {
...
void CodegenCorenrnCppVisitor::print_instance_variable_setup() {
