 ...
 */
template <>
std::string format_double_string<CodegenCoreneuronCppVisitor>(const std::string& s_value) {
...
template <>
std::string format_float_string<CodegenCoreneuronCppVisitor>(const std::string& s_value) {
