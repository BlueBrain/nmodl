...
SCENARIO("Instance Struct creation", "[visitor][llvm][instance_struct]") {
    GIVEN("Instantiate simple Instance Struct") {
        ...
        THEN("instance struct elements are properly initialized") {
            ...
            REQUIRE(compare_vectors(instance_data.members[ena_index],
                                    generate_double_data(ena_index, num_elements)));
            REQUIRE(compare_vectors(instance_data.members[ion_ena_index],
                                    generate_double_data(ion_ena_index, num_elements)));
            REQUIRE(compare_vectors(instance_data.members[node_index_index],
        ...
        THEN("instance struct is properly initialized") {
            ...
            test__instance_var__type* test_instance_struct = static_cast<test__instance_var__type*>(
