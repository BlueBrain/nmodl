...
SCENARIO("Parse UNITS block of mod files using Units Visitor", "[visitor][units]") {
    GIVEN("UNITS block with different cases of units definitions") {
        ...
        degK 1.00000000: K1
        FARADAY1 0x1.78e555060882cp+16: coul1
        FARADAY2 0x1.81f0fae775425p+6: coul1
        FARADAY3 0x1.34c0c8b92a9b7p+3: coul1
        PI 0x1.921fb54442d18p+1: constant
        R1 0x1.0a1013e8990bep+3: m2 kg1 sec-2 K-1
        R2 8.314: m2 kg1 sec-2 K-1
        R3 0x1.03d3b37125759p+13: m2 kg1 sec-2 K-1
