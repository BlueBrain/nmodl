...
python benchmark_script.py --modfiles "./kernels/hh.mod" --architectures "default" "nehalem" "broadwell" "skylake-avx512" --compilers "" --output "./python_script_test" --instances 100000000 --experiments 1 --svml_lib $svml_lib --intel_exe $intel_exe --sleef_lib $sleef_lib --clang_exe $clang_exe --llc_exe $llc_exe --gcc_exe $gcc_exe --libdevice_lib $libdevice_lib --nmodl_exe $nmodl_exe
